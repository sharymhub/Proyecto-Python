...
from Formularios_Profesores.form_horarios_profesores import FormularioHorariosVista
from Formularios_Profesores.form_perfil_profesores import formularioPerfilProfesores
from Formularios_Profesores.form_estudiantes_profesores import FormEstudiantesVistaProfesor
import subprocess

class formularioPrincipalProfesores(tk.Tk):
    ...
    def controles_menu_lateral(self):
        ...
        self.buttonPerfil = tk.Button(self.menu_lateral)
        ...
        buttons_info = [
            ("Perfil", self.buttonPerfil, self.abrir_seccion_perfil),
    ...
    def abrir_seccion_estudiantes(self):
        ...
        FormEstudiantesVistaProfesor(self.cuerpo_principal)
    
    def abrir_seccion_horarios(self):
        self.limpiar_panel(self.cuerpo_principal)
        FormularioHorariosVista(self.cuerpo_principal)

    def limpiar_panel(self, panel):
        for widget in panel.winfo_children():
            widget.destroy()
    
    def abrir_seccion_perfil(self):
        self.limpiar_panel(self.cuerpo_principal)
        formularioPerfilProfesores(self.cuerpo_principal)
